...
export default function DonateFunds() {
  return (
    <div className="space-y-8">
      <SectionHeading
        title="Donate Funds (Official Government Link)"
        description="Financial donations are handled via the official Sri Lankan government platform. This keeps contributions secure, transparent, and accountable."
      />
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Use the official portal to make a secure donation. You will be redirected to the government website.
            </p>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-6 shadow-soft">
          <h3 className="text-lg font-semibold">Why the official portal?</h3>
          <p className="mt-2 text-muted-foreground">
            It helps donors in Sri Lanka and abroad contribute with confidence through an established, recognized platform.
          </p>
        </div>
        <div className="rounded-xl border border-border bg-card p-6 shadow-soft">
